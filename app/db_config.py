...
REFRESH_TOKEN_EXPIRE_DAYS_token = fernet.encrypt(b"" + os.environ["REFRESH_TOKEN_EXPIRE_DAYS"].encode())
REFRESH_TOKEN_EXPIRE_DAYS = int(fernet.decrypt(REFRESH_TOKEN_EXPIRE_DAYS_token).decode('utf-8'))
